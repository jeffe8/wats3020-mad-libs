...
let familyMember = prompt('Name a family member (Mother, Father, Brother, Sister)');

// TODO: A variable named "organ" for the name of a body organ (e.g. heart, liver, spleen, etc.).
let organ = prompt('Name an organ of the body.');
...
let bodyPart3 = prompt('....And another body part.');
...
let thing2 = prompt('Name an object that you wuld give to someone you love');

// TODO: A variable named "thing3" for an object you might give somebody you like.
let thing3 = prompt('Name an object that you would give to someone you like');

// TODO: A variable named "adjective4" for a word used to describe the vehicle.
let adjective4 = prompt('How would you describe a vehicle');

// TODO: A variable named "adjective5" for a word used to describe the vehicle.
let adjective5 = prompt('How would you describe a vehicle, again...but better this time...');
...
let userNumber = prompt('Choose a number that is not Zero....Any number will do.');
